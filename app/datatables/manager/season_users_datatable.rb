  ...
  def data
    users.map do |uSeason|
      ...
      if uSeason.clubs.first
        tName = image_tag("#{session[:pdbprefix]}/teams/#{uSeason.clubs.first.def_team.name.upcase.delete(" ")}.png", style: "width: 32px; height: 32px", class: "me-1", onerror: "this.error=null;this.src='#{vite_asset_url("images/generic-team.png")}';")
