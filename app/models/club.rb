class Club < ApplicationRecord
  ...
  has_many :from_club, class_name: "ClubExchange", foreign_key: :from_club_id, dependent: :destroy
  has_many :to_club, class_name: "ClubExchange", foreign_key: :to_club_id, dependent: :destroy
