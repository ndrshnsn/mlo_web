Rails.application.routes.draw do
  ...
  post 'cleague/:id', to: 'dashboard#change_league', as: :change_active_league
	...
	as :user do
		...
		## Confirmations
		get 'confirmations/resend', to: 'users/confirmations#new', as: :new_confirmation
    ...
    get 'profile/social', to: 'profile#social', as: :profile_social
		...
		## Confirmation
		get 'activate', to: 'users/confirmations#new'
		post 'activate', to: 'users/confirmations#create'
